...
func (bs *BoardScene) AddSquares() {
	...
	lastmovearrow := gui.NewQPixmap5(":qml/assets/toolbar/ic_last_page_white_48dp_2x.png", "png", core.Qt__AutoColor)
	scaledlastmovearrow := lastmovearrow.Scaled2(scalex, scaley, core.Qt__KeepAspectRatio, core.Qt__SmoothTransformation)
	lastmovearrowitem := widgets.NewQGraphicsPixmapItem2(scaledlastmovearrow, nil)
	lastmovearrowitem.SetTransformationMode(core.Qt__SmoothTransformation)
	bs.AddItem(lastmovearrowitem)
	lastmovearrowitem.SetPos2(posx-float64(buttonnumber*scalex), posy)
	lastmovearrowitem.SetFlag(widgets.QGraphicsItem__ItemIsMovable, false)
	lastmovearrowitem.ConnectMousePressEvent(func(ev *widgets.QGraphicsSceneMouseEvent) {
	...
	buttonnumber++
	nextmovearrow := gui.NewQPixmap5(":qml/assets/toolbar/ic_chevron_right_white_48dp_2x.png", "png", core.Qt__AutoColor)
	scalednextmovearrow := nextmovearrow.Scaled2(scalex, scaley, core.Qt__KeepAspectRatio, core.Qt__SmoothTransformation)
	nextmovearrowitem := widgets.NewQGraphicsPixmapItem2(scalednextmovearrow, nil)
	nextmovearrowitem.SetTransformationMode(core.Qt__SmoothTransformation)
	bs.AddItem(nextmovearrowitem)
	nextmovearrowitem.SetPos2(posx-float64(buttonnumber*scalex), posy)
	nextmovearrowitem.SetFlag(widgets.QGraphicsItem__ItemIsMovable, false)
	nextmovearrowitem.ConnectMousePressEvent(func(ev *widgets.QGraphicsSceneMouseEvent) {
	...
	buttonnumber++
	previousmovearrow := gui.NewQPixmap5(":qml/assets/toolbar/ic_chevron_left_white_48dp_2x.png", "png", core.Qt__AutoColor)
	scaledpreviousmovearrow := previousmovearrow.Scaled2(scalex, scaley, core.Qt__KeepAspectRatio, core.Qt__SmoothTransformation)
	previousmovearrowitem := widgets.NewQGraphicsPixmapItem2(scaledpreviousmovearrow, nil)
	previousmovearrowitem.SetTransformationMode(core.Qt__SmoothTransformation)
	bs.AddItem(previousmovearrowitem)
	previousmovearrowitem.SetPos2(posx-float64(buttonnumber*scalex), posy)
	previousmovearrowitem.SetFlag(widgets.QGraphicsItem__ItemIsMovable, false)
	previousmovearrowitem.ConnectMousePressEvent(func(ev *widgets.QGraphicsSceneMouseEvent) {
	...
	buttonnumber++
	firstmovearrow := gui.NewQPixmap5(":qml/assets/toolbar/ic_first_page_white_48dp_2x.png", "png", core.Qt__AutoColor)
	scaledfirstmovearrow := firstmovearrow.Scaled2(scalex, scaley, core.Qt__KeepAspectRatio, core.Qt__SmoothTransformation)
	firstmovearrowitem := widgets.NewQGraphicsPixmapItem2(scaledfirstmovearrow, nil)
	firstmovearrowitem.SetTransformationMode(core.Qt__SmoothTransformation)
	bs.AddItem(firstmovearrowitem)
	firstmovearrowitem.SetPos2(posx-float64(buttonnumber*scalex), posy)
	firstmovearrowitem.SetFlag(widgets.QGraphicsItem__ItemIsMovable, false)
	firstmovearrowitem.ConnectMousePressEvent(func(ev *widgets.QGraphicsSceneMouseEvent) {
